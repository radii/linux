...
mt9v034_update_hblank(struct mt9v034 *mt9v034)
{
	...
	return mt9v034_write(client, MT9V034_HORIZONTAL_BLANKING,
			     max_t(s32, mt9v034->hblank,
			     MT9V034_TOTAL_ROW_TIME_MIN - crop->width));
}
...
#define V4L2_I2C_BACKDOOR		0x9f0902
...
static const char * const mt9v034_test_pattern_menu[] = {
	"Disabled",
	"Gray Vertical Shade",
		...
		const struct i2c_device_id *did)
{
	...
	v4l2_ctrl_handler_init(&mt9v034->ctrls, 10);
	...
	if (ret < 0) {
		v4l2_ctrl_handler_free(&mt9v034->ctrls);
		kfree(mt9v034);
	}
